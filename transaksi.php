...
if (isset($_POST['tambah'])) {
    ...
    if ($stok) {
        ...
        $sql = $koneksi->query("INSERT INTO pelanggan (id_pelanggan, NamaPelanggan, NoMeja) VALUES ('$id_transaksi_baru', '$nama', '$nomeja')");
        ...
        foreach ($menu_jumlah as $i => $item) {
            ...
            $sql4 = $koneksi->query("UPDATE produk SET Stok = Stok - $jumlah  WHERE ProdukID = '$id_produk'");
            $sql5 = $koneksi->query("UPDATE produk SET Terjual = Terjual + $jumlah WHERE ProdukID = '$id_produk'");
        }
